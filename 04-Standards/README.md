...
This directory contains the standards, conventions, and operating rules that guide the OnTheMarkNetwork GitHub organization and project work.
...
Build the foundation before the growth requires it - but do not build more foundation than the organization has learned it needs.
